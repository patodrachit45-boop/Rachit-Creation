...
import { CATEGORIES, formatPrice, type BlogPost, type TeamMember, type FAQ, type ReelItem } from '../lib/siteConfig';
import {
...
export default function AdminDashboard() {
  ...
  const updateReel = useStore((s) => s.updateReel);
  const deleteReel = useStore((s) => s.deleteReel);
  ...
  const fetchReels = useStore((s) => s.fetchReels);
  ...
  useEffect(() => { 
    ...
    fetchReels();
    fetchSiteSettings(); 
  }, [fetchProducts, fetchBlogs, fetchTeamMembers, fetchFaqs, fetchReels, fetchSiteSettings]);
